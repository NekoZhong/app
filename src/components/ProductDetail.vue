      ...
      <div class="food-wrapper">
        <div class="food-content">
          <div class="img-wrapper">
            <img src="" class="food-img" :src="food.picture">
            <span class="close-bt icon-close" @click="closeView"></span>
            <img src="../assets/img/share.png" class="share-bt">
            <img src="../assets/img/more.png" class="more-bt">
          </div>
...
.food .food-wrapper .food-content .carcontrol-wrapper{
	position: absolute;
	right: 12px;
	bottom: 10px;
	padding: 2px;
